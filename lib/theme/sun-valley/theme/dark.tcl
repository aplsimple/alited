    ...
    ttk::style theme create sun-valley-dark -parent clam -settings {
        ...
        ttk::style element create Button.button image \
            [list $images(button-rest) \
                ...
                focus $images(button-accent-pressed) \
                {active !selected} $images(button-rest) \
                {active selected} $images(button-accent-pressed) \
        ...
        ttk::style element create Checkbutton.indicator image \
            [list $images(check-unsel-rest) \
                ...
                {!focus !selected} $images(check-unsel-rest) \
        ...
        # Scrollbar
        ttk::style element create Horizontal.Scrollbar.trough image $images(scroll-hor-trough) -sticky ew -border 3
        ...
        ttk::style element create Vertical.Scrollbar.trough image $images(scroll-vert-trough) -sticky ns -border 3
