...
namespace eval ttk::theme::radiance {
    ...
    array set I [LoadImages \
                     [file join [file dirname [info script]] radiance] *.png]
...
#!
        ...
        ttk::style element create Horizontal.Scrollbar.thumb image [list $I(scroll-hor-thumb)  \
        ...
        ttk::style element create Vertical.Scrollbar.thumb image [list $I(scroll-vert-thumb) \
