...
%#t geo=1296x500+100+100;pos=5.74 cd %PD|!||!|echo ===============================================================================|!||!| grep -E -H -n -I -s -d recurse --include '*tcl' --include '*html' -e '%s' %ls|!||!|echo ===============================================================================|!|echo year 1900-2099|!||!| grep -E -H -n -I -s -i -d recurse * -e '(^|[^[:digit:]])(19|20)[[:digit:]]{2}([^[:digit:]]|$)'|!||!|echo ===============================================================================|!|echo email|!||!| grep -E -H -n -I -s -i -d recurse * -e '[_]*([a-z0-9]+(\\.|_*)?)+@([a-z][a-z0-9-]+(\\.|-*\\.))+[a-z]{2,6}'|!||!|echo ===============================================================================|!|echo "in: $PWD"
