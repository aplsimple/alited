...
#### ________________________ Tree's toolbar _________________________ ####
    ...
    {.fraBot.panBM.fraTree.fra1.BuTswitch - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_gulls -com alited::tree::SwitchTree}}
    {.fraBot.panBM.fraTree.fra1.BuTUpdT - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_retry -tip {$alited::al(MC,updtree)}
    -command alited::main::UpdateAll}}
    {.fraBot.panBM.fraTree.fra1.sev1 - - - - {pack -side left -fill y -padx 5}}
    {.fraBot.panBM.fraTree.fra1.BuTUp - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_up -com {alited::tree::MoveItem up}}}
    {.fraBot.panBM.fraTree.fra1.BuTDown - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_down -com {alited::tree::MoveItem down}}}
    {.fraBot.panBM.fraTree.fra1.sev2 - - - - {pack -side left -fill y -padx 5}}
    {.fraBot.panBM.fraTree.fra1.BuTAddT - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_add -com alited::tree::AddItem}}
    {.fraBot.panBM.fraTree.fra1.BuTRenT - - - - {pack forget -side left -fill x} {$::apave::BUTTOOL -image alimg_change -tip {$alited::al(MC,renamefile)} -com {::alited::file::RenameFileInTree 0 -geometry pointer+10+10}}}
    {.fraBot.panBM.fraTree.fra1.BuTDelT - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_delete -com alited::tree::DelItem}}
    {.fraBot.panBM.fraTree.fra1.h_ - - - - {pack -anchor center -side left -fill both -expand 1}}
    {.fraBot.panBM.fraTree.fra1.buTCtr - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_minus -com {alited::tree::ExpandContractTree Tree no} -tip "Contract All"}}
    {.fraBot.panBM.fraTree.fra1.buTExp - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_plus -com {alited::tree::ExpandContractTree Tree} -tip "Expand All"}}
{#
...
#### ________________________ Favorites' toolbar _________________________ ####
    ...
    {.fraFV.fra1.BuTVisitF - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_misc -tip {$alited::al(MC,lastvisit)} -com alited::favor::SwitchFavVisit}}
    {.fraFV.fra1.sev0 - - - - {pack -side left -fill y -padx 5}}
    {.fraFV.fra1.BuTListF - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_SaveFile -tip {$alited::al(MC,FavLists)} -com alited::favor::Lists}}
    {.fraFV.fra1.sev1 - - - - {pack -side left -fill y -padx 5}}
    {.fraFV.fra1.BuTAddF - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_add -tip {$alited::al(MC,favoradd)} -com alited::favor::Add}}
    {.fraFV.fra1.BuTRenF - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_change -tip {$alited::al(MC,favorren)} -command ::alited::favor::Rename}}
    {.fraFV.fra1.BuTDelF - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_delete -tip {$alited::al(MC,favordel)} -com alited::favor::Delete}}
    {.fraFV.fra1.BuTDelAllF - - - - {pack -side left -fill x} {$::apave::BUTTOOL -image alimg_trash -tip {$alited::al(MC,favordelall)} -com alited::favor::DeleteAll}}
...
#### ________________________ Favorites' list _________________________ ####
    ...
    {.fraFV.fra.TreeFavor - - - - {pack -side left -fill both -expand 1} {-h 5 -style TreeNoHL -columns {C1 C2 C3 C4} -displaycolumns C1 -show headings -takefocus 0 -tip {-BALTIP {alited::favor::GetTooltip %i} -SHIFTX 10}}}
...
### ________________________ Find units _________________________ ###
    ...
    {.fraTop.fraHead.buT - - - - {pack -side left -padx 4} {-t "Find: " $::apave::BUTTOOL -com alited::find::DoFindUnit -w 8 -anchor e -tip {Find Unit}}}
    ...
    {.fraTop.fraHead.buTno - - - - {pack -side left} {$::apave::BUTTOOL -command {alited::find::HideFindUnit}}}
{#
