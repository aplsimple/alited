...
proc ::alited::favor_ls::Show {} {
  ...
  $obDl2 paveWindow $win {
    ...
    {.TexFav - - - - {pack -side left -expand 1 -fill both} {-h 10 -w 50 -tooltip {$alited::al(MC,favent2)} -ro 1}}
...
proc ::alited::favor_ls::Save_favlist {} {
  variable favlist
  variable favlistsaved
  set favlistsaved $favlist
}

proc ::alited::favor_ls::Restore_favlist {} {
  variable favlist
  variable favlistsaved
  set favlist $favlistsaved
}

proc ::alited::favor_ls::Ok {{res 0}} {
...
proc ::alited::favor_ls::Cancel {args} {
  namespace upvar ::alited obDl2 obDl2
  variable win
  Save_favlist
  $obDl2 res $win 0
...
proc ::alited::favor_ls::Message {msg {first 1}} {
  namespace upvar ::alited obDl2 obDl2
  alited::Message $msg $first [$obDl2 LabFav]
}

proc ::alited::favor_ls::Selected {} {
  namespace upvar ::alited al al obDl2 obDl2
  variable favlist
  if {[set isel [[$obDl2 LbxFav] curselection]] eq ""} {
    Message $al(MC,favsel) 2
  }
  return $isel
}

proc ::alited::favor_ls::Text {} {
  namespace upvar ::alited obDl2 obDl2
  return [[$obDl2 TexFav] get 1.0 "end -1 char"]
}

proc ::alited::favor_ls::Select {{isel ""}} {
  namespace upvar ::alited obDl2 obDl2
  variable favlist
  variable favcont
  variable favpla
...
proc ::alited::favor_ls::Focus {isel} {
  namespace upvar ::alited obDl2 obDl2
  set lbx [$obDl2 LbxFav]
...
proc ::alited::favor_ls::Add {} {
  ...
  if {$fav ne "" && $cont ne "" && $found} {
    Message $al(MC,favexists) 2
    Select $isel
    return
  } elseif {$fav eq ""} {
    focus [$obDl2 EntFav]
    Message $al(MC,favent1) 2
    return
  } elseif {[string trim $cont] eq ""} {
    Message $al(MC,favent3) 2
    return
  } else {
    set isel end
    lappend favlist $fav
...
proc ::alited::favor_ls::IniFile {} {
  return [file join $alited::INIDIR favor_ls.ini]
}

proc ::alited::favor_ls::GetCurrentList {args} {
  namespace upvar ::alited obDl2 obDl2
  variable currents
...
proc ::alited::favor_ls::Split {lines} {
  return [split [string map [list $::alited::EOL \n] $lines] \n]
}

proc ::alited::favor_ls::GetIni {lines} {
  variable favlist
  variable favcont
  variable favpla
