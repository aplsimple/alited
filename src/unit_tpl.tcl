...
proc ::alited::unit_tpl::Show {} {
  ...
  $obDl2 paveWindow $win {
    ...
    {.TreeTpl - - - - {pack -side left -expand 1 -fill both} {-show headings -columns {C1 C2} -displaycolumns {C1 C2} -columnoptions "C2 {-width 20}"}}
    ...
    {.EntTpl fra1.labTpl L 1 8 {-st we} {-tvar ::alited::unit_tpl::tpl -w 40 -tooltip {$alited::al(MC,tplent1)}}}
    {.CbxKey fra1.EntTpl L 1 1 {-st we} {-tvar ::alited::unit_tpl::tplkey -postcommand ::alited::unit_tpl::GetKeyList -state readonly -h 16 -w 20 -tooltip {$alited::al(MC,tplcbx)}}}
...
proc ::alited::unit_tpl::UpdateTree {} {
  namespace upvar ::alited al al obDl2 obDl2
  variable tpllist
  variable tplkeys
  variable tplid
...
proc ::alited::unit_tpl::ClearCbx {} {
  namespace upvar ::alited obDl2 obDl2
  [$obDl2 CbxKey] selection clear
}

proc ::alited::unit_tpl::Selected {what {domsg yes}} {
  namespace upvar ::alited al al obDl2 obDl2
  variable tpllist
  set tree [$obDl2 TreeTpl]
...
proc ::alited::unit_tpl::Select {{item ""}} {
  variable tpllist
  variable tplkey
  variable tplkeys
  variable tplcont
...
proc ::alited::unit_tpl::RegisterKeys {} {
  namespace upvar ::alited al al
  variable tpllist
  variable tplcont
  variable tplkeys
...
proc ::alited::unit_tpl::GetKeyList {} {
  namespace upvar ::alited obDl2 obDl2
  RegisterKeys
